...
HI_S32 SAMPLE_INNER_CODEC_CfgAudio(AUDIO_SAMPLE_RATE_E enSample)
{
    ...
    ACODEC_FS_E i2s_fs_sel = ACODEC_FS_BUTT;
    int iAcodecInputVol = 0;
    ACODEC_MIXER_E input_mode = ACODEC_MIXER_BUTT;
...
//             //printf("SAMPLE_COMM_AUDIO_AencProc- Time: %lu \n", timestamp);
...
******************************************************************************/
// HI_S32 SAMPLE_COMM_AUDIO_CreatTrdAencAdec(pthread_t* aencPid, AENC_CHN AeChn, ADEC_CHN AdChn, FILE* pAecFd)
// {
...
//     printf("SAMPLE_COMM_AUDIO_CreatTrdAencAdec \n");
...
//     HI_S32 nRet = pthread_create(&pstAenc->stAencPid, 0, SAMPLE_COMM_AUDIO_AencProc, pstAenc);
