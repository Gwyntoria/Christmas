...
HI_S32 SAMPLE_COMM_VI_StartMIPI(SAMPLE_VI_CONFIG_S* pstViConfig)
{
    ...
    lane_divide_mode = (lane_divide_mode_t)SAMPLE_COMM_VI_GetMipiLaneDivideMode(pstViConfig);
...
HI_S32 SAMPLE_COMM_VI_StartDev(SAMPLE_VI_INFO_S* pstViInfo)
{
    ...
    SAMPLE_PRT("enSnsType = %d, ViDev = %d!\n", enSnsType, ViDev);
