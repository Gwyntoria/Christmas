 ...
 * 
 * @param VpssGrp vpss group num
 * @param pabChnEnable 
 * @param pstVpssGrpAttr vpss group attribute
 * @param pastVpssChnAttr vpss group channel attribute
 * @return HI_S32 
 */
HI_S32 SAMPLE_COMM_VPSS_Start(VPSS_GRP VpssGrp, HI_BOOL* pabChnEnable, VPSS_GRP_ATTR_S* pstVpssGrpAttr, VPSS_CHN_ATTR_S* pastVpssChnAttr)
{
    ...
    // if (s32Ret != HI_SUCCESS)
    // {
    //     SAMPLE_PRT("HI_MPI_VPSS_GetGrpAttr(grp:%d) failed with %#x!\n", VpssGrp, s32Ret);
    //     return HI_FAILURE;
    // }
