...
*/
void Hi_IR_STRONG_TEST_001(void)
{
    int filp = 0;
    int i = 0;
    hiir_dev_param tmp;
...
void Hi_IR_STRONG_TEST_002(void)
{
    int filp = 0;
...
*/
void Hi_IR_STRONG_TEST_003(void)
{
    /*
    Press down REMOTE_POWER key to finish the test:
    Press down REMOTE_F1 key to set support release key msg(0--no,1--yes);
